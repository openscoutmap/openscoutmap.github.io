! function(e) {
	...
	e.exports = '<a class="{{ model.className }}-toggle js-toggle" href=# title="Measure distances and areas">Messung</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Messung von Abständen und Flächen</h3> <ul class=tasks> <a href=# class="js-start start">Eine neue Messung durchführen</a> </ul> </div> <div class=js-measuringprompt> <h3>Messung von Abständen und Flächen</h3> <p class=js-starthelp>Führen Sie die Messung durch, indem Sie der Karte Punkte hinzufügen.</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Abbrechen</a></li> <li><a href=# class="js-finish finish">Messung beenden</a></li> </ul> </div> </div> '
}, function(e, t, r) {
	e.exports = '<div class=group> <p class="lastpoint heading">Letzter Punkt</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distanz</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Fläche</span> {{ model.areaDisplay }}</p> </div> <% } %> '
}, function(e, t, r) {
	e.exports = '<h3>Lage des Punkts</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Auf diesen Ort zentrieren</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Löschen</a></li> </ul> '
}, function(e, t, r) {
	e.exports = '<h3>Gemessener Abstand</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Auf diesen Linienzug zentrieren</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Löschen</a></li> </ul> '
}, function(e, t, r) {
	e.exports = '<h3>Gemessene Fläche</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Umfang</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Auf diese Fläche zentrieren</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Löschen</a></li> </ul> '
}]);